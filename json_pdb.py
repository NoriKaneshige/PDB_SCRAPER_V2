...
class Create_Json_File:
    def __init__(self, filename):
        """Load cache from disk, if present, otherwise, creat a new diction"""
    ...
    def get(self, identifier):
        ...
        identifier = identifier # Assuming none will differ with case sensitivity here
    ...
    def set(self, identifier, data):
        ...
        identifier = identifier # make unique
